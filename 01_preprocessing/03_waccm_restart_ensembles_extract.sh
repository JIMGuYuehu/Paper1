...
# INPUT
#   Raw perfect-model restart files under /mnt/backup_ETH/lens/0008-01 and
#   /mnt/backup_ETH/lens/0008-02; a member may contain several h3 segments.
# OUTPUT
...
INPUT_BASE="${PAPER1_HINDCAST_SOURCE:-/mnt/backup_ETH/lens}"
...
python "${SCRIPT_DIR}/paper1_source_audit.py" hindcast \
...
python "${SCRIPT_DIR}/paper1_source_audit.py" hindcast-outputs \
    --root "${OUTPUT_BASE}" \
