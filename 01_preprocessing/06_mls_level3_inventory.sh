...
#   /mnt/soclim0/public_data/weiji/MLS/Level3_Zonal_v5/ClO
#   /mnt/soclim0/public_data/weiji/MLS/Level3_Zonal_v5/H2O
...
MLS_ROOT="${PAPER1_MLS_SOURCE:-/mnt/soclim0/public_data/weiji/MLS/Level3_Zonal_v5}"
INVENTORY="${PAPER1_DERIVED_ROOT}/manifests/mls_level3_v5_2004_2020.tsv"
prepare_output_file "${INVENTORY}"

python "${SCRIPT_DIR}/paper1_source_audit.py" mls \
    --root "${MLS_ROOT}" \
    --start-year 2004 \
    --end-year 2020 \
    --output "${INVENTORY}"
