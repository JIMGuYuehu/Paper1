...
#   ${PAPER1_ARCHIVE_ROOT}/WACCM/longrun/run001
#   ${PAPER1_ARCHIVE_ROOT}/WACCM/longrun/run002
# OUTPUT
...
SRC_RUN001="${PAPER1_WACCM_LONGRUN_001:-${PAPER1_ARCHIVE_ROOT}/WACCM/longrun/run001}"
SRC_RUN002="${PAPER1_WACCM_LONGRUN_002:-${PAPER1_ARCHIVE_ROOT}/WACCM/longrun/run002}"
